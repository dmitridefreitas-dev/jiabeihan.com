...
const BLOBS = [
  ['18%', '12%',  '50vw', '50vw', 'rgba(200,127,150,0.08)',  28, 0.6, 0],
  ['68%', '8%',   '42vw', '42vw', 'rgba(126,212,188,0.07)',  36, 0.5, 1],
  ['5%',  '52%',  '38vw', '38vw', 'rgba(232,197,96,0.06)',   22, 0.5, 2],
  ['72%', '55%',  '46vw', '46vw', 'rgba(195,181,232,0.06)',  42, 0.4, 3],
  ['40%', '80%',  '32vw', '32vw', 'rgba(200,127,150,0.05)',  18, 0.4, 4],
];
